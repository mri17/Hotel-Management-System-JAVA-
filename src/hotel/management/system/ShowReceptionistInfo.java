...
public class ShowReceptionistInfo extends JFrame implements ActionListener, Searchable {
    ...
    ShowReceptionistInfo() {
        ...
        JLabel heading = new JLabel("RECEPTIONIST INFO");
        heading.setFont(new Font("Tahoma", Font.BOLD, 24));
        heading.setBounds(450, 5, 300, 30);
        add(heading);
        ...
        l3.setBounds(320, 50, 100, 20);
        add(l3);

        JLabel l4 = new JLabel("Degree");
        l4.setBounds(460, 50, 100, 20);
        add(l4);

        JLabel l5 = new JLabel("Salary");
        l5.setBounds(590, 50, 100, 20);
        add(l5);

        JLabel l6 = new JLabel("Phone");
        l6.setBounds(730, 50, 100, 20);
        add(l6);

        JLabel l7 = new JLabel("Email");
        l7.setBounds(860, 50, 100, 20);
        add(l7);

        JLabel l8 = new JLabel("NID No.");
        l8.setBounds(990, 50, 100, 20);
        add(l8);

        JLabel l9 = new JLabel("Language skills");
        l9.setBounds(1100, 50, 100, 20);
        add(l9);

        table = new JTable();
        table.setBounds(10, 80, 1200, 400);
